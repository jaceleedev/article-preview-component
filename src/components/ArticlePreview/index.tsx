...
function ArticlePreview() {
  ...
  return (
    <article className="relative grid grid-cols-1 grid-rows-[200px_auto] w-[327px] rounded-[10px] bg-white shadow-[0px_40px_40px_-10px_rgba(201,213,225,0.50)] md:grid-cols-[285px_auto] md:grid-rows-1 md:w-[730px]">
      <header className="relative h-[200px] md:h-[280px]">
        <Image
      ...
      <div className="pt-9 px-8 pb-5 md:px-10 md:py-8">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-author">
                <span className="sr-only">Author: </span>Michelle Appleton
              </p>
              <p className="text-date">
                <span className="sr-only">Publication date: </span>28 Jun 2020
              </p>
            </div>
          </div>
          <ShareButton
        ...
        <dialog
          ...
          className="absolute left-0 bottom-0 md:left-3/4 md:translate-x-[2.3px] md:bottom-1/3"
        >
          <ShareBar />
        </dialog>
      </div>
